...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='timestamp',
            field=models.DateTimeField(default=datetime.datetime(2021, 2, 4, 16, 54, 35, 457827)),
        ),
        migrations.AlterField(
            model_name='employee',
            name='timeStamp',
            field=models.DateTimeField(default=datetime.datetime(2021, 2, 4, 16, 54, 35, 458871)),
        ),
        migrations.AlterField(
            model_name='employee',
            name='username',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timeStamp', models.DateTimeField(default=datetime.datetime(2021, 2, 4, 16, 54, 35, 458871))),
